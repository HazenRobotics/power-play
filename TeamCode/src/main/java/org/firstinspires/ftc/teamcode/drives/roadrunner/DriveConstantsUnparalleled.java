 ...
 */
@Config
public class DriveConstantsUnparalleled {
    ...
    public static double TRACK_WIDTH = 9.66; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(348.4856497943485);
    public static double MAX_ANG_ACCEL = Math.toRadians(348.4856497943485);
