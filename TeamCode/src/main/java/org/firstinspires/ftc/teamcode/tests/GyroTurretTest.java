...
import org.firstinspires.ftc.teamcode.subsystems.ServoGyroTurret;
import org.firstinspires.ftc.teamcode.utils.GamepadEvents;

@TeleOp(group = "Test")
public class GyroTurretTest extends OpMode {

	GamepadEvents gamepad;
	ServoGyroTurret turret;
	boolean async = false;
	...
	public void init( ) {
		...
		turret = new ServoGyroTurret( hardwareMap, "turret", "turr", false, true, AngleUnit.RADIANS, 2000, 15.0 / 170 );
